...
export default {
  ...
  setup() {
    ...
    function initSwiper(){
      new Swiper(".popular_catalog_swiper", {
        direction: "horizontal",
        modules: [Navigation],
        slidesPerView: 3,
        spaceBetween: 12,
        navigation: {
          nextEl: '.popular_catalog_next',
          prevEl: '.popular_catalog_prev',
        },
        breakpoints: {
          1040:{
            slidesPerView: 3,
...
<template>
  <section class="popular">
    <div class="container">
      <div class="popular_title fz-20 fw-700">{{ title }}</div>
      <div class="popular_wrapper d-flex align-start mt-14">
        <div class="popular_catalog_swiper">
          <div class="prev popular_catalog_prev">
          ...
          <div class="next popular_catalog_next">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="10" viewBox="0 0 18 10" fill="none">
