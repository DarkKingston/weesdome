...
<template>
  <section class="popular">
    <div class="container">
      <div class="popular_title fz-20 fw-700">Самые дорогие виллы</div>
      <div class="no_overflow">
        <div class="prev expensive_prev">
        ...
        <div class="popular_wrapper expensive_objects d-flex align-start mt-14">
